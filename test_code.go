...
var (
	...
	primaryIp         = flag.String("primary_ip", "", "service primary ip address")
	secondaryIp       = flag.String("secondary_ip", "127.0.0.1", "service secondary ip address")
	keepaliveService2 = flag.String("keepalive_service2", "HostClient,http://:10010^http://:10010#http://127.0.0.1:10010", "checker service list")
